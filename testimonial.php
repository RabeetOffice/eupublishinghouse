...
$reviews = [
    ...
    ['name' => 'J. R. Kaelen',  'role' => 'Fantasy Author',   'rating' => 5, 'text' => 'My fantasy series found its proper home. Every page &mdash; text, cover, paper stock &mdash; was considered. That is unbelievably rare in modern publishing.'],
    ...
    ['name' => 'Elena Hart',    'role' => 'Novelist',         'rating' => 5, 'text' => 'They saw the book the way I saw it &mdash; and pushed me to write the version I had been too afraid to commit to. A truly literary partnership.'],
