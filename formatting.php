        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="why-eph-art">
                    <img src="<?= asset('images/FormattingMatters-2048x1536.webp') ?>" alt="Why formatting matters more than most authors realise" loading="lazy" decoding="async">
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="publish-cost-art">
                    <img src="<?= asset('images/BookFormattingCost-2048x1536.webp') ?>" alt="How much does book formatting cost in Europe" loading="lazy" decoding="async">
                </div>
            </div>
            <div class="col-lg-6" data-aos="fade-left">
