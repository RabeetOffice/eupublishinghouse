...
<section class="services-section" id="format-services">
    <div class="container">
        <div class="section-head text-center" data-aos="fade-up">
            ...
            <h2 class="section-title">Book Formatting Services <em class="gold-italic">We Offer</em></h2>
            <p class="hero-sub" style="max-width:760px;margin-inline:auto;">Every format your book needs, produced correctly first time.</p>
        </div>
