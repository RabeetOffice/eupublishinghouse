...
<section class="services-section" id="other-services">
    <div class="container">
        <div class="section-head text-center" data-aos="fade-up">
            ...
            <h2 class="section-title">Other Services <em class="gold-italic">We Offer</em></h2>
        </div>
        ...
        <div class="services-grid mt-5">
            <?php $i = 0; foreach ($_otherServices as $slug => $svc):
                ...
                <article class="service-card" data-aos="fade-up" data-aos-delay="<?= $i * 70 ?>">
                    ...
                    <a href="<?= safe($svc['url']) ?>" class="service-link">Learn more <i class="fa-solid fa-arrow-right"></i></a>
